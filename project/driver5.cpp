...
int main()
{
  ...
  cout << "rv from renameFile /h /x is " << r <<(r==-3 ? " correct /i dir exists": " fail") <<endl;
  r = c1->myFS->renameDirectory(const_cast<char *>("/$"), 2, const_cast<char *>("/z"), 2);
  cout << "rv from renameFile /h /x is " << r <<(r==-1 ? " correct /$  invalid": " fail") <<endl;
  ...
  cout << "rv from renameFile /h /o is " << r <<(r==-3 ? " correct /o exists": " fail") <<endl;

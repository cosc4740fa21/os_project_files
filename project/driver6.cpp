...
int main()
{
  ...
  cout << "rv from createFile /o/o/o/a fs2 is " << r <<(r==0 ? " correct ": " fail") <<endl;
  ...
  cout << "rv from deleteDirectory /o/o/o/a fs2 is " << r <<(r==0 ? " correct":" fail") <<endl;
  r = c5->myFS->deleteDirectory(const_cast<char *>("/o/o/o/z"), 8);
  cout << "rv from deleteDirectory /o/o/o/z fs2 is " << r <<(r==-1 ? " correct":" fail") <<endl;
